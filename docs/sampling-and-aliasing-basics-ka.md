...
### მაგალითი: ტონი ზოლის შიგნით და ალიასინგით

`aliasing_demo.py` და `plot_spectrum.py`-ის გამოყენებით (Fs = 2 MS/s):

**ტონი ნიქვისტის ზოლის შიგნით (უბრალოდ პიკი თავის ადგილზე):**

![ტონი ზოლის შიგნით](../images/aliasing_tone_right.png)

**ტონი ნიქვისტის ზოლზე გარეთ (ალიასინგი):**

![ალიასირებული ტონი](../images/aliasing_tone_left.png)

**რა ჩანს ამ გრაფიკებზე**

- ორივე შემთხვევაში ჰორიზონტალური ღერძი არის **სიხშირე** MHz-ებში
  საბაზისო ფანჯარაში [−Fs/2, +Fs/2], ვერტიკალური ღერძი კი **სიმძლავრე dB-ში**.
- მაღალი, ვიწრო პიკები არის ერთი-ერთი **ტონური სიგნალები**, რომელიც
  სპეციალურად გენერირებულია IQ ფაილში.
- ბრტყელი „ძირა“ წარმოადგენს რიცხვით **ხმაურს** და FFT-ის ეფექტებს.

პირველ სპექტრში ყველაზე ძლიერი პიკი ფანჯრის ერთ კიდესთან არის.
ეს მაგალითია ტონის, რომელიც **ნიქვისტის ზოლის საზღვართან ახლოს** დგას:
ჯერ კიდევ მკაფიო ხაზად ჩანს, მაგრამ თუ სიხშირეს ოდნავ უფრო მაღლა ავწევთ,
იგი **ალიასინგით** გადახტება სპექტრის სხვა ადგილზე.

მეორე სპექტრში ყველაზე ძლიერი პიკი უფრო ცენტრთან არის.
აქ ტონი **კომფორტულად ნიქვისტის დიაპაზონის შიგნით**აა, ამიტომ
ალიასინგი არ ხდება და პიკი ზუსტად იქ ჩანს, სადაც მოველით –
იმ სიხშირეზე, რომელზეც ტონი დავაგენერირეთ.

თუ `aliasing_demo.py`-ში ტონის სიხშირეს ვცვლით და სპექტრს თავიდან
ვაანგარიშებთ, ძალიან ნათლად ჩანს, რომ:

- ტონები, რომლებიც [−Fs/2, +Fs/2] დიაპაზონშია, სპექტრში „გვადგებიან“,
- ხოლო ტონები, რომლებიც ამ დიაპაზონს გარეთ არიან, **იკეცებიან**
  (aliasing) და ამ ფანჯარაში სხვა პოზიციებზე ჩნდებიან.
